...
export function NewsCard({ article }: NewsCardProps) {
    ...
    return (
        <Card className="h-full flex flex-col overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group border-muted-foreground/10">
            {article.image_url ? (
                ...
                <div className="relative h-48 bg-gradient-to-br from-primary/10 via-primary/5 to-background flex items-center justify-center border-b border-muted/30">
                    <div className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_2px_2px,var(--primary)_1px,transparent_0)] [background-size:24px_24px]" />
